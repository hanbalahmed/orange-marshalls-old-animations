...
public class TextSelector extends Selector {
    ...
    public TextSelector(int componentId, FontRenderer fontrendererObj, int x, int y, int width, int height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            boolean flag = this.cursorPosition < this.text.length() || this.text.length() >= this.getMaxStringLength();
            int k1 = j1;
